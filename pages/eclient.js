...
const contract = new ethers.Contract(address, ERC20_ABI,mysigner)
  ...
  async function signup()
  {
    ...
    await contract.addclient(name,cin);
   }
   console.log("done");
  }
  ...
  return(<div>
    ...
    * {
    ...
    `}
        ...
        <h1>Register for kyc</h1>
        <div className="content">
          <div className="input-field">
            <input type="text" placeholder="National Identity card number" id="cin" name="cin"></input>
          </div>
          <div className="input-field">
        ...
        <div className="action">
          <button onClick={e=>signup()}>Register</button>
          <Link href='/status'><button>check my status</button></Link>
        </div>
